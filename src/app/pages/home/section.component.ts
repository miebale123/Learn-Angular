  ...
  template: `
    <section class="py-24 bg-gray-50 text-gray-900">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
        <div
          class="p-8 rounded-2xl bg-white shadow-sm hover:shadow-md border border-gray-200 transition"
        >
      ...
      <div class="max-w-6xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="bg-white rounded-3xl shadow-md p-10 text-center">
            ...
            <button
              class="px-6 py-2 border border-blue-600 text-blue-600 rounded-xl hover:bg-blue-50 transition"
            >
              Find a local agent
            </button>
          </div>
